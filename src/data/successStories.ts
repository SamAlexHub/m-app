...
export const SUCCESS_STORIES: SuccessStory[] = [
  {
    ...
    quote: 'Evervow brought together two souls separated by oceans. From our first AI compatibility match to our Lake Como vows, every moment felt destined.',
    story: 'Sebastian, an investment director from Zurich, and Evelyn, an art conservator from London, matched with a 99% AI compatibility rating on Evervow. Their shared vision for family, art, and timeless values transformed virtual conversations into a magical European romance.',
    timeline: [
  ...
  },
  {
    ...
    quote: 'Our families immediately bonded over shared values and warm traditions. Evervow is truly the gold standard of meaningful matrimony.',
    story: 'Vikram, a tech entrepreneur from San Francisco, met Isabel, a pediatric surgeon from Geneva. Through Evervow’s Family Access shield and VIP Concierge, both families were involved from day one, laying a foundation of unconditional trust.',
    timeline: [
